...
function getServiceTerms() {
  return `제1조 (목적)
이 약관은 오랄케어샵(이하 "회사")이 운영하는 인터넷 쇼핑몰(이하 "몰")에서 제공하는 인터넷 관련 서비스(이하 "서비스")를 이용함에 있어 회사와 이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.
...
오랄케어샵(이하 "회사")은 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호에 관한 법률", "개인정보보호법" 등 관련 법령을 준수하고 있습니다.
...
오랄케어샵에서 제공하는 이벤트/혜택 등 다양한 정보를 휴대전화 문자메시지(SMS), 이메일로 받아보실 수 있습니다.
